    ...
    <>
      <div className="content">
        ...
        <div className="content__description">
          <h3>an e-book store build with React, Redux, Express and MongoDB</h3>
        </div>
        ...
        <div className="content__feature_list">
          <div>
            <ul>
              <li>
                <h3>product searchbox</h3>
              </li>
              <li>
                <h3>customized product page</h3>
              </li>
              <li>
                <h3>customized shopping cart page</h3>
              </li>
              <li>
                <h3>refreshable best selling product jumbotron</h3>
              </li>
            </ul>
          </div>
          <div>
            <ul>
              <li>
                <h3>paypal api intergration</h3>
              </li>
              <li>
                <h3>product rate and review system</h3>
              </li>
              <li>
                <h3>user register/login JWT authentication</h3>
              </li>
              <li>
                <h3>administrator inventory management system</h3>
              </li>
            </ul>
          </div>
        </div>
